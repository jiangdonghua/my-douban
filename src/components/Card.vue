<template>
  <div class="card">
    <div class="desc">
      ...
      <a href="#">
        <div class="user-info">
          ...
          <div class="timestamp">{{dateTime | formatDate}}</div>
        </div>
      </a>
    </div>
    <div v-if="mold==='quote'" class="article-card">
      ...
      <div class="detail">
        - “我的”-“电影电视”-“讨论”中为你筛选了正在看及刚看过的电影电视，追剧讨论更便利； - 小组体验...
      </div>
    </div>
    ...
    <div class="info">
      <span class="btn like"><i>23</i></span>
      <span v-if="mold==='quote'" class="btn comment"></span>
      <span v-if="mold==='quote'" class="btn retweet"></span>
