  ...
  <div class="group">
    ...
    <ul class="content">
      <li v-for="item in items">
        <router-link :to="{name:'SubjectView',params:{classify:item.subtype?item.subtype:'book',id:item.id}}">
          <div class="group-meta">
            <template v-if="item.image"><img :src="item.image" alt="cover"></template>
            <template v-if="!item.image"><img :src="item.images.small" alt="cover"></template>
